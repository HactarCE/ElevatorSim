...
class Building:
    """A building with an elevator and a platform at each floor."""

    def __init__(self, floors: List[Platform], elevator: Elevator = None, **kwargs):
        self.floors = floors
        self.elevator = elevator or Elevator(len(floors), **kwargs)
